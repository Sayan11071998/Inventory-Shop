...
public class InventoryController
{
    ...
    private int GetRandomIndex()
    {
        ...
        do
        {
            index = Random.Range(0, GetItemDatabase().Count);
    ...
    {
        Dictionary<int, ItemView> instantiatedItems = inventoryModel.GetInstatiatedItems();
    ...
    private bool IsItemForValue(int index)
    {
        ...
        return inventoryModel.IsRarityAvailable(itemRarity);
    }
    ...
    public int GenerateRandomQuantity() => Random.Range(1, 3);
    ...
    public float GetTotalWeight()
    {
        ...
        foreach (var totalItemWeight in inventoryModel.GetInstatiatedItems())
            totalWeight += GetItemWeight(totalItemWeight.Key);
        return totalWeight;
    }
